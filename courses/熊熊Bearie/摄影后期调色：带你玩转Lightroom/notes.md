...
应该是开始修图的第一步，但是使用频率并不高。

#### HDR曝光合成（拼合曝光）

动态范围就是画面当中最亮到最暗的部分。

比如日落大光比的情况下很难拍出正常曝光的照片，场景的动态范围已经超过了相机能够拍下的全部动态范围了。

由于相机能记录的动态范围是有限的，大光比情况下可能就需要记录三次才行，这就是HDR或者包围曝光的原理。

![](./asserts/%E5%8A%A8%E6%80%81%E8%8C%83%E5%9B%B4.png)

通常会拍一张欠曝的照片来留用高光信息，一张正常的0Ev的照片保留中间调信息，一张过曝的照片保留阴影信息。LRC后期再通过把三张照片有用的信息拼到一起合成一张照片。

![](./asserts/HDR.png)

合成步骤：

选中两张照片，右键-照片合并-HDR，LDR会自动操作。

默认会勾选上自动对齐（建议勾选），以及自动设置（相当于面板上的自动按钮，会调整曝光）自动设置这里不选到面板后面调整时再选也可以。尾影消除质量，是指在拍摄风光、树叶或者车流这种运动的物体，在多张合成时由于位置在变化，会有伪影/残影，这时可以调高一些，平时拍摄静物关掉就行，轻微运动可以点成低。

HDR合成的照片，曝光度可以从-10-10，而普通照片只能是-5-5调整，说明动态范围更大，从天空到地面的各种细节都可以随心所欲调整。

#### 全景接片合成（拼合视角）

![](./asserts/全景照片.png)

需要注意的是每张照片有一定重合度，可以提高拼合成功率。

选择照片，右键-照片合并-全景图，LDR会自动拼接。

- 投影：可以都选一下看哪个更自然，广角的照片用球面或圆柱会比较多；长焦用透视会比较多。

- 边界变形：根据图确定，看哪个会让边界看起来更舒服。
...
全景照片HDR合成，每一张照片，包围曝光的几个挡位需要相同且等距，可以借用相机内的曝光补偿工具。

![](./asserts/%E5%85%A8%E6%99%AFHDR.png)
